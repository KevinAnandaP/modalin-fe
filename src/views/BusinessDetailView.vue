    ...
    <div class="bg-white p-8 sm:p-10 rounded-xl border border-[#0F6E56]/40 shadow-xs w-full max-w-4xl mx-auto font-inter my-8 text-left">
      ...
      <div v-else-if="isForbidden" class="py-10 text-center space-y-4 max-w-md mx-auto">
        ...
        <div>
          ...
          <h3 class="text-xl font-bold text-[#1F2937] font-newsreader">
        ...
        <div class="pt-2 flex flex-col gap-2">
          <button
            ...
            class="w-full py-2.5 bg-[#0F6E56] hover:bg-[#0A5744] text-white text-xs font-semibold rounded-lg transition-colors cursor-pointer"
          >
      ...
      <div v-else-if="isNotFound" class="py-10 text-center space-y-4 max-w-md mx-auto">
        ...
        <div class="pt-2">
          <button
            ...
            class="px-5 py-2.5 bg-[#0F6E56] hover:bg-[#0A5744] text-white text-xs font-semibold rounded-lg transition-colors cursor-pointer"
          >
      ...
      <div v-else-if="errorMessage" class="py-8 text-center space-y-3">
        ...
        <button @click="fetchBusiness" class="px-4 py-2 bg-[#0F6E56] text-white text-xs font-semibold rounded-lg">
          Coba Lagi
        </button>
      </div>
